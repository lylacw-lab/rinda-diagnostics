...
// Tailored local fallback catalog matching your exact requested categories
const MOCK_CATALOG: MedicalProduct[] = [
  {
    ...
    sku: "RD-LAB-CEN",
    price: 145000,
    description: "Brushless high-speed diagnostic centrifuge with automated imbalance monitoring and lid lock protection.",
    in_stock: true,
  },
  {
    id: "prod-2",
  ...
  },
  {
    ...
    sku: "RD-SUR-FOR",
    price: 12800,
    description: "Clinical grade stainless steel surgical clamp kit. Pack of 10 sterile individual instruments.",
    in_stock: true,
  },
  {
    id: "prod-4",
  ...
  },
  {
    ...
    sku: "RD-IND-MIX",
    price: 380000,
    description: "High-torque multi-speed fluid processing station engineered for industrial chemical synthesis.",
    in_stock: false,
  },
  {
    id: "prod-6",
...
export default function CatalogPage() {
  ...
  // Define explicit category tab sorting row order to ensure clean navigation layout
  const categories = [
    "All Categories", 
    "Medical equipment", 
    ...
    <div className="w-full min-h-screen bg-slate-50 pb-20">
      ...
      <section className="w-full bg-gradient-to-r from-pink-700 via-pink-600 to-pink-800 text-white py-16 md:py-24 px-4 shadow-inner relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 space-y-6">
          ...
          <p className="text-pink-100/90 max-w-3xl mx-auto text-sm md:text-base font-normal leading-relaxed">
          ...
          <div className="pt-6 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-xs font-semibold text-pink-100">
            <div className="flex items-center justify-center gap-2 bg-white/5 py-2.5 px-4 rounded-xl border border-white/10">
              <CheckCircle2 className="w-4 h-4 text-pink-300 flex-shrink-0" /> Surgical Certified
            </div>
            <div className="flex items-center justify-center gap-2 bg-white/5 py-2.5 px-4 rounded-xl border border-white/10">
              <CheckCircle2 className="w-4 h-4 text-pink-300 flex-shrink-0" /> Scientific Precision
            </div>
            <div className="flex items-center justify-center gap-2 bg-white/5 py-2.5 px-4 rounded-xl border border-white/10">
              <CheckCircle2 className="w-4 h-4 text-pink-300 flex-shrink-0" /> Industrial Grade
            </div>
            <div className="flex items-center justify-center gap-2 bg-white/5 py-2.5 px-4 rounded-xl border border-white/10">
              <CheckCircle2 className="w-4 h-4 text-pink-300 flex-shrink-0" /> Institutional Contracts
            </div>
          </div>
        </div>
      </section>

      {/* Interactive Search Bar & Dynamic Category Filter Sorters */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div className="bg-white p-4 rounded-2xl border border-pink-100 shadow-sm flex flex-col gap-4 justify-between items-center">
          ...
          {/* Dynamic Horizontal Scrolling Pill Selectors */}
          <div className="w-full flex items-center gap-2 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-pink-200">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        {loading ? (
          ...
          <div className="w-full bg-white border border-dashed border-slate-300 py-16 rounded-2xl text-center max-w-xl mx-auto mt-6">
            ...
            <p className="text-xs text-slate-400 mt-1">Try selecting another filter button above or clearing your search input terms.</p>
          </div>
        ) : (
